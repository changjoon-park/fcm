...
ARTIFACT_SCHEMA = {
    ART_CHROME: [
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_CHROME_HISTORY}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_CHROME_DOWNLOADS}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_CHROME_KEYWORD_SEARCH_TERMS}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_CHROME_AUTOFILL}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_CHROME_LOGIN_DATA}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_CHROME_BOOKMARKS}.yaml",
    ],
    ART_EDGE: [
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_EDGE_HISTORY}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_EDGE_DOWNLOADS}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_EDGE_KEYWORD_SEARCH_TERMS}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_EDGE_AUTOFILL}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_EDGE_LOGIN_DATA}.yaml",
        ARTIFACT_SCHEMA_BROWSER / f"{RSLT_EDGE_BOOKMARKS}.yaml",
    ],
    ART_IEXPLORER: [
