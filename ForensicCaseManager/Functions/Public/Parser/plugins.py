...
PLUGINS = {
    ...
    "RecycleBin": Plugin(
        artifact=RecycleBin, category=CATEGORY_DELETED_ITEMS_FILE_EXISTENCE
    ),  # ! Windows
    ...
    "USB(EventLog)": Plugin(
        artifact=ForensicEvent, category=CATEGORY_EXTERNAL_DEVICE_USB_USAGE
    ),
    "WLAN": Plugin(
        artifact=ForensicEvent, category=CATEGORY_NETWORK_ACTIVITY_PHYSICAL_LOCATION
    ),
    "Amcache": Plugin(
        artifact=Amcache, category=CATEGORY_APPLICATION_EXECUTION
    ),  # ! Registry
    ...
    "NetworkInfo": Plugin(
        artifact=NetworkInfo, category=CATEGORY_NETWORK_ACTIVITY_PHYSICAL_LOCATION
    ),
